...
import com.caknow.android.customer.app.util.TimeUtils;

import java.util.HashMap;
import java.util.Map;

/**
 * <strong>HttpResponse</strong>
 * <ul>
 ...
 *     <li>{@link #getUrl()}</li>
 *     <li>{@link #getExpiredTime()} expire time</li>
...
public class HttpResponse {
     ...
     */
    private void setResponseHeaders(Map<String,Object> responseHeaders) {
     ...
     * <ul>
     *     <li>current time is bigger than expired time, it means this response is dirty</li>
     * </ul>
     * @return <ul>
    ...
    public long getExpiredTime() {
        if(isInitExpiredTime) {
            ...
            return expiredTime = getExpiredTime();
        }
    }

    /**
     * setting expired time in millis
     * @param expiredTime
     */
    ...
    /**
     * get isInCache, this is a client mark
     * @return
     */
    ...
    /**
     * setting isInCache this is a client mark
     * @param isInCache
     * @return
     */
    ...
    /**
     * http expires in response header
    ...
    /**
     * http cache-control in response header
    ...
    private long getCacheControlMaxAge() {
        try {
            ...
            if(!StringUtils.isEmpty(cacheControl)) {
                int start = cacheControl.indexOf("max-are=");
                if(start != -1) {
     ...
     * </ul>
     */
    public long getExpirseInMillis() {
    ...
    /**
     * get response header, not available not
     * @param field
     * @return
     */
    public Object getResponseHeader(String field) {
