package com.caknow.android.customer.app.constant;
...
public class DbConstants {
    ...
    static {
        ...
        CREATE_IMAGE_SDCARD_CACHE_TABLE_SQL.append(" (").append(IMAGE_SDCARD_CACHE_TABLE_ID).append(" integer primary key autoincrement,");
        ...
        CREATE_IMAGE_SDCARD_CACHE_TABLE_SQL.append(IMAGE_SDCARD_CACHE_TABLE_CREATE_TIME).append(" integer,");
        ...
        CREATE_IMAGE_SDCARD_CACHE_TABLE_SQL.append(IMAGE_SDCARD_CACHE_TABLE_ISFOREVER).append(" integer)");
        ...
        CREATE_IMAGE_SDCARD_CACHE_TABLE_INDEX_SQL.append("CREATE INDEX ").append(IMAGE_SDCARD_CACHE_TABLE_INDEX_TAG)
                ...
                .append(IMAGE_SDCARD_CACHE_TABLE_TAG).append(")").append(TERMINATOR)
                .append("CREATE INDEX ").append(IMAGE_SDCARD_CACHE_TABLE_URL)
                .append(" ON ").append(IMAGE_SDCARD_CACHE_TABLE_TABLE_NAME).append("(")
        ...
        CREATE_HTTP_CACHE_TABLE_SQL.append(" (").append(HTTP_CACHE_TABLE_ID).append(" integer primary key autoincrement,");
        ...
        CREATE_HTTP_CACHE_TABLE_UNIQUE_INDEX.append("CREATE UNIQUE INDEX ")
                .append(HTTP_CACHE_TABLE_UNIQUE_INDEX_URL)
                .append(" ON ")
                .append(HTTP_CACHE_TABLE_TABLE_NAME).append("(")
                .append(HTTP_CACHE_TABLE_URL).append(")")
                .append(TERMINATOR);
        CREATE_HTTP_CACHE_TABLE_INDEX_SQL.append("CREATE INDEX ")
                .append(HTTP_CACHE_TABLE_INDEX_TYPE)
                .append(" ON ")
                .append(HTTP_CACHE_TABLE_TABLE_NAME).append("(")
                .append(HTTP_CACHE_TABLE_TYPE).append(")")
                .append(TERMINATOR);
    }
